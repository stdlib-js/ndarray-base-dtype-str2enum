...
```javascript
str2enum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-dtype-str2enum@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-dtype-str2enum/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-base-dtype-str2enum/actions/workflows/test.yml?query=branch:v0.1.0
